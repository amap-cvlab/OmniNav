...
class Blip2QFormerModelTester:
    def __init__(
        ...
        bos_token_id=0,
        scope=None,
        action_former_text_input=False,
    ):
        self.parent = parent
        self.batch_size = batch_size
        ...
        self.action_former_text_input = action_former_text_input
    ...
    def get_config(self):
        return Blip2QFormerConfig(
            ...
            action_former_text_input=self.action_former_text_input,
        )
...
class Blip2TextModelWithProjectionTester:
    def __init__(self, parent, vision_kwargs=None, qformer_kwargs=None, is_training=True):
        if vision_kwargs is None:
            vision_kwargs = {}
        if qformer_kwargs is None:
            qformer_kwargs = {"action_former_text_input": True}
